...
REM SET ADTPRO_HOME=C:\src\workspace\311\adtpro\build\ADTPro-1.3.0.jar\
REM SET MY_JAVA_HOME=E:\Java142\jre\bin\

SETLOCAL

CD %ADTPRO_HOME%disks
%MY_JAVA_HOME%java -Xms128m -Xmx256m -cp %ADTPRO_HOME%lib\ADTPro-1.3.0.jar;%ADTPRO_HOME%lib\rxtx\rxtx-2.2pre2-local\RXTXcomm.jar org.adtpro.ADTPro %*
